 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://javacodegeeks.rpc/", wsdlLocation = "http://localhost:8888/webservice/helloworld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://javacodegeeks.rpc/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/webservice/helloworld?wsdl");
    ...
    public WebServiceInterface getWebServiceImplPort() {
        return super.getPort(new QName("http://javacodegeeks.rpc/", "WebServiceImplPort"), WebServiceInterface.class);
    }
    ...
    public WebServiceInterface getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://javacodegeeks.rpc/", "WebServiceImplPort"), WebServiceInterface.class, features);
    }
